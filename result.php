        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    //$a = new Db();  // or whatever class is needed
                    //  $item = new Item();  // Instantiate the item class
                    ...
                    if (isset($_GET['keyword'])) {
                        ...
                        //var_dump($a->Search($keyword, 0, 2));
                        foreach ($a->Search($keyword, 0, 6) as $key => $x):

                    ?>

                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <img class="img-fluid w-100" src="img/<?php echo $x['img'] ?>" style="object-fit: cover;">
                                    <div class="bg-white border border-top-0 p-4">
                                        <div class="mb-2">
                                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                                href=""><?php echo $item->HienThiMotCategoryes($x['category'])[0]['name'] ?></a>
                                            <a class="text-body" href=""><small><?php echo $x['created_at'] ?></small></a>
                                        </div>
                                        <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href=""><?php echo $x['title'] ?></a>
                                        <p class="m-0"><?php echo $x['excerpt'] ?></p>
                                    </div>
                                    <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                        <div class="d-flex align-items-center">
                                            <img class="rounded-circle mr-2" src="img/<?php echo $x['img'] ?>" width="25" height="25" alt="">
                                            <small> <?php echo $user->HienThiMotUser($x['author'])[0]['name'] ?> </small>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <small class="ml-3"><i class="far fa-eye mr-2"></i><?php echo $x['views'] ?></small>
                                            <small class="ml-3"><i class="far fa-comment mr-2"></i><?php echo $x['views'] ?></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
