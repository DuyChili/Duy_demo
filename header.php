...
$user = new User();
// //$item->HienThi();
// foreach ($a->HienThi() as $key => $y) {
//     if ($y['id'] === 2) {
//         $motitem = $y['id'];
//         break;
//     }
// }
// var_dump($a->HienThiMotItem($motitem)[0]);
?>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <?php foreach ($item->HienThi() as $key => $x): ?>
                        <a href="archive.php?cate-id=<?php echo $x['id'] ?>" class="nav-item nav-link"><?php echo $x['name'] ?></a>
                    <?php endforeach ?>
